...
const CharacterCustomizer = () => {
    ...
    const cycleOption = (category, forward = true) => {
        ...
        if (forward) {
            ...
            newIndex =
                (currentIndex - 1 + options[category].length) %
        ...
        >
            <div
                style={{
                    ...
                    background: `url(/assets/Character/Walking/${
                        src === "PlayerWalking_V01.png" ||
                        src === "PlayerWalking_V02.png" ||
    ...
    const CustomizationOption = ({ category, value }) => (
        <div className="flex items-center justify-between w-full mb-4 font-malio text-xs">
            ...
            >
                <img
                    src="/assets/hud/Customize/leftArrow.png"
                    alt="Previous"
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        "url('/assets/hud/Customize/selectionBackground.png')",
                    minHeight: "60px",
                    display: "flex",
                    alignItems: "center",
            ...
            >
                <img
                    src="/assets/hud/Customize/rightArrow.png"
                    alt="Next"
                    className="w-full h-full"
                />
            </button>
    ...
    return (
        <div
            ...
            style={{
                backgroundImage:
                    "url('/assets/hud/Customize/CharacterSelectFrame.png')",
            ...
            <div className="flex gap-8 p-8">
                ...
                <div className="flex flex-col items-center">
                    <div className="relative w-[200px] h-[200px] rounded-lg mb-4 flex items-center justify-center">
                        <div
                            className="absolute transform translate-x-4 translate-y-4"
                            style={{
