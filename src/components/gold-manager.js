class GoldManager {
    ...
    setGold(amount) {
        ...
        console.log(
            `GoldManager: Setting gold to ${newAmount} (was ${this.goldAmount})`
        );
    ...
    addGold(amount) {
        ...
        console.log(
            `GoldManager: Adding ${amount} gold. New total: ${newAmount}`
        );
    ...
    spendGold(amount) {
        ...
        if (this.goldAmount < amount) {
            console.log(
                `GoldManager: Not enough gold to spend ${amount}. Current gold: ${this.goldAmount}`
            );
            return false;
        }
        ...
        const newAmount = this.goldAmount - amount;
        console.log(
            `GoldManager: Spending ${amount} gold. New total: ${newAmount}`
        );
    ...
    updateGameGold() {
        ...
        if (instance.TotalGoldPrefab) {
            ...
            if (instance.TotalGoldPrefab.totalGoldAmountText) {
                instance.TotalGoldPrefab.totalGoldAmountText.setText(
                    this.goldAmount.toString()
                );
            }
        }
