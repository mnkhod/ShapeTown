...
const GameErrorFallback = (error, retry, errorId) => {
    ...
    const handleReportBug = () => {
        ...
        navigator.clipboard
            ...
            .then(() => {
                alert(
                    "Error report copied to clipboard! Please paste this in your bug report."
                );
            });
    };
            ...
            <div className="game-error-content bg-black/80 backdrop-blur-sm rounded-lg border border-purple-500/30 p-8 max-w-2xl w-full text-white">
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-300">
                        Harvestyn encountered an unexpected error. Your progress
                        will be saved before restarting.
                    </p>
                </div>
                ...
                <div className="mt-6 text-center text-sm text-gray-400">
                    <p>
                        Your game progress is automatically saved every few
                        minutes.
                    </p>
