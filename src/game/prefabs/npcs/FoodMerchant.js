...
export default class FoodMerchant extends Phaser.GameObjects.Container {
    ...
    async updateMakingFriendsProgress() {
        try {
            console.log("🤝 Checking if 'Making Friends' quest is active for Lily...");
            ...
            console.log("✅ 'Making Friends' quest is active! Updating progress for Lily...");
            ...
            console.log("✅ 'Making Friends' quest progress updated for Lily");
        } catch (error) {
