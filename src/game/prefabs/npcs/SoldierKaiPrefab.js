...
export default class SoldierKaiPrefab extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        super(scene, x ?? 32, y ?? 32);

        // Kai NPC
        /** @type {Phaser.GameObjects.Sprite & { body: Phaser.Physics.Arcade.Body }} */
        const npc = scene.add.sprite(0, 0, "NPCGuardian_V01", 3);
        npc.scaleX = 1.5;
        npc.scaleY = 1.5;
    ...
    dialogueLines = [
        { msg: "Hu aahh…" },
        { msg: "We are here to guard Lady Lydia and Captain Marcus their shipment!" }
    ];
    ...
    getDistance(texture1, texture2) {
        ...
        return Phaser.Math.Distance.Between(
            texture1.x, texture1.y, texture2.x, texture2.y
        );
    }
