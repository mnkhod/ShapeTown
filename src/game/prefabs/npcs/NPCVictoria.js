...
export default class NPCVictoria extends Phaser.GameObjects.Image {
	...
	async updateMakingFriendsProgress() {
		try {
			console.log("🤝 Checking if 'Making Friends' quest is active for Victoria...");
			...
			console.log("✅ 'Making Friends' quest is active! Updating progress for Victoria...");
			...
			console.log("✅ 'Making Friends' quest progress updated for Victoria");
		} catch (error) {
