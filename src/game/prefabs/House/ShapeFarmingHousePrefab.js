...
export default class ShapeFarmingHousePrefab extends Phaser.GameObjects.Image {

    constructor(scene, x, y, texture, frame) {
        super(scene, x ?? 128, y ?? 208, texture || "CityHouses_v02", frame ?? 0);
        ...
        this.body.setSize(246, 170);
        this.body.setOffset(5, 245);
