...
export default class FarmingTree2 extends Phaser.GameObjects.Image {

    constructor(scene, x, y, texture, frame) {
        super(scene, x ?? 431, y ?? 342, texture || "Tree_v05", frame ?? 0);
        ...
        scene.events.on('update', () => {
            ...
            const playerNearTreeX = Math.abs(this.player.x - (this.x + this.body.offset.x - 60)) < 65;
