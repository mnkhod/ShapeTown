...
export default class ShapeTownSquareMapScene extends Phaser.Scene {
    ...
    editorCreate() {
        ...
        shapetownSquare.addTilesetImage(
            "GroundTileset_V02",
            "GroundTileset_V02"
        );
        ...
        shapetownSquare.addTilesetImage(
            "RiverShallowSheet_v01",
            "RiverShallowSheet_v01"
        );
        shapetownSquare.addTilesetImage(
            "StoneBridgeHorizontal_V01",
            "StoneBridgeHorizontal_V01"
        );
        shapetownSquare.addTilesetImage(
            "StoneBridgeVertical_V01",
            "StoneBridgeVertical_V01"
        );
        ...
        shapetownSquare.addTilesetImage(
            "dragon fossil - complete - with grass"
        );
        shapetownSquare.addTilesetImage(
            "AdventureGuildBuilding",
            "AdventureGuildBuilding"
        );
        shapetownSquare.addTilesetImage(
            "NPCSoilderSpearAttack_V01",
            "NPCSoilderSpearAttack_V01"
        );
        shapetownSquare.addTilesetImage("NPCGuardian_V01", "NPCGuardian_V01");
        shapetownSquare.addTilesetImage(
            "NPCSoildersFullsetWalking_V01",
            "NPCSoildersFullsetWalking_V01"
        );
        ...
        shapetownSquare.addTilesetImage(
            "NPCMarcus_Mining_Fullset",
            "NPCMarcus_Mining_Fullset"
        );
        shapetownSquare.addTilesetImage(
            "NPCRowan_Fullset_Walk_V01",
            "NPCRowan_Fullset_Walk_V01"
        );
        shapetownSquare.addTilesetImage(
            "NPCShopStandMaerchant",
            "NPCShopStandMaerchant"
        );
        shapetownSquare.addTilesetImage("NPCGuardian_V01", "NPCGuardian_V01");

        // bG_grass_1
        const bG_grass_1 = shapetownSquare.createLayer(
            "BG/grass",
            ["GroundTileset_V02"],
            0,
            0
        ...
        // bG_stone_road_1
        const bG_stone_road_1 = shapetownSquare.createLayer(
            "BG/stone road",
            ["GroundTileset_V02"],
            0,
            0
        ...
        // bG_tallgrass_1
        const bG_tallgrass_1 = shapetownSquare.createLayer(
            "BG/tallgrass",
            ["GroundTileset_V02"],
            0,
            0
        ...
        // collution_Cliff_1
        const collution_Cliff_1 = shapetownSquare.createLayer(
            "Collution/Cliff",
            ["GroundTileset_V02"],
            0,
            0
        ...
        const collution_WoodenFence_1 = shapetownSquare.createLayer(
            "Collution/WoodenFence",
            ["Fence_V01"],
            0,
            0
        );
        ...
        const collution_StoneFence_1 = shapetownSquare.createLayer(
            "Collution/StoneFence",
            ["GroundTileset_V02"],
            0,
            0
        );
        ...
        // river_River_1
        const river_River_1 = shapetownSquare.createLayer(
            "River/River",
            ["RiverShallowSheet_v01", "GroundTileset_V02"],
            0,
            0
        );

        // decoration_
        const decoration_ = shapetownSquare.createLayer(
            "Decoration/9",
            ["TreePatteren"],
            0,
            0
        ...
        const decoration_Decoration_1 = shapetownSquare.createLayer(
        ...
        // decoration_Tree_1
        const decoration_Tree_1 = shapetownSquare.createLayer(
            "Decoration/Tree",
            [],
            0,
            0
        ...
        // decoration_Log_1
        const decoration_Log_1 = shapetownSquare.createLayer(
            "Decoration/Log",
            ["Log_V01"],
            0,
            0
        ...
        // decoration_bush_1
        const decoration_bush_1 = shapetownSquare.createLayer(
            "Decoration/bush",
            ["bush"],
            0,
            0
        ...
        // tree_left_side_
        const tree_left_side_ = shapetownSquare.createLayer(
            "Tree left side/8",
            ["TreePatteren"],
            0,
            0
        ...
        // tree_left_side_1
        const tree_left_side_1 = shapetownSquare.createLayer(
            "Tree left side/6",
            ["TreePatteren"],
            0,
            0
        ...
        // tree_left_side_2
        const tree_left_side_2 = shapetownSquare.createLayer(
            "Tree left side/5",
            ["TreePatteren"],
            0,
            0
        ...
        // tree_left_side_3
        const tree_left_side_3 = shapetownSquare.createLayer(
            "Tree left side/4",
            ["TreePatteren"],
            0,
            0
        ...
        // tree_left_side_4
        const tree_left_side_4 = shapetownSquare.createLayer(
            "Tree left side/3",
            ["TreePatteren"],
            0,
            0
        ...
        // tree_left_side_5
        const tree_left_side_5 = shapetownSquare.createLayer(
            "Tree left side/2",
            ["TreePatteren"],
            0,
            0
        ...
        // forager_home_Tent_1
        const forager_home_Tent_1 = shapetownSquare.createLayer(
            "Forager home/Tent",
            ["Tent_V02"],
            0,
            0
        ...
        // tree_left_side_6
        const tree_left_side_6 = shapetownSquare.createLayer(
            "Tree left side/1",
            ["TreePatteren"],
            0,
            0
        ...
        const forager_home_Baket_of_mushrooms_1 = shapetownSquare.createLayer(
            "Forager home/Baket of mushrooms",
            ["Apple"],
            0,
            0
        );
        ...
        const forager_home_Basket_of_apple_1 = shapetownSquare.createLayer(
            "Forager home/Basket of apple",
            ["Apple"],
            0,
            0
        );
        ...
        const foodStand_Foodstand_1 = shapetownSquare.createLayer(
            "FoodStand/Foodstand",
            [],
            0,
            0
        ...
        const foodStand_Fishbarrel_1 = shapetownSquare.createLayer(
            "FoodStand/Fishbarrel",
            ["FoodstandBarrel_V01"],
            0,
            0
        );
        ...
        // foodStand_stall_1
        const foodStand_stall_1 = shapetownSquare.createLayer(
            "FoodStand/stall",
            ["FoodstandStall_V01"],
            0,
            0
        ...
        // foodStand_Foodstand
        const foodStand_Foodstand = shapetownSquare.createLayer(
            "FoodStand/Foodstand",
            [],
            0,
            0
        ...
        const foodStand_Fishbarrel = shapetownSquare.createLayer(
            "FoodStand/Fishbarrel",
            ["FoodstandBarrel_V01"],
            0,
            0
        ...
        // foodStand_stall
        const foodStand_stall = shapetownSquare.createLayer(
            "FoodStand/stall",
            ["FoodstandStall_V01"],
            0,
            2
        ...
        // foodStand_Basket_1
        const foodStand_Basket_1 = shapetownSquare.createLayer(
            "FoodStand/Basket",
            ["Foodstand_Busket"],
            0,
            0
        ...
        const mechant_MerchantCarriage_1 = shapetownSquare.createLayer(
            "Mechant/MerchantCarriage",
            ["MerchentanCarriege"],
            0,
            0
        );
        ...
        // barracks_Barricade
        const barracks_Barricade = shapetownSquare.createLayer(
            "Barracks/Barricade3",
            [
                "BarricadeSpikes_V02",
                "BarricadeSpikes_V03",
        ...
        const barracks_Barricade_1 = shapetownSquare.createLayer(
            "Barracks/Barricade2",
            [
                "BarricadeSpikes_V03",
                "BarricadeSpikes_V02",
        ...
        const barracks_Barricade_2 = shapetownSquare.createLayer(
            "Barracks/Barricade1",
            [
                "Barricade_V01",
                "BarricadeSpikes_V02",
        ...
        const squareCampFirePrefab_1 = new SquareCampFirePrefab(
            this,
            1910,
            420
        );
        ...
        const squareCampFirePrefab_2 = new SquareCampFirePrefab(
            this,
            2190,
            220
        );
        ...
        const mineWatchTowerPrefab_1 = new MineWatchTowerPrefab(
            this,
            1609,
            130
        );
        ...
        // barracks_Tents_1
        const barracks_Tents_1 = shapetownSquare.createLayer(
            "Barracks/Tents",
            ["Tent_V04", "Tent_V03"],
            0,
            0
        ...
        const squareDragonHousePrefab = new SquareDragonHousePrefab(
            this,
            2800,
            1269
        );
        ...
        const squareCampFirePrefab_3 = new SquareCampFirePrefab(
            this,
            2800,
            2700
        );
        ...
        const stoneBridgeDownPrefab = new StoneBridgeDownPrefab(
            this,
            2408,
            2536
        );
        ...
        const stoneBridgeRightPrefab = new StoneBridgeRightPrefab(
            this,
            3183,
            1757
        );
        ...
        // decoration_Rock
        const decoration_Rock = shapetownSquare.createLayer(
            "Decoration/Rock1",
            ["RockOnGrass_V02"],
            0,
            0
        ...
        // decoration_Rock_1
        const decoration_Rock_1 = shapetownSquare.createLayer(
            "Decoration/Rock4",
            ["RockOnGrass_V04"],
            0,
            0
        ...
        // decoration_Rock_2
        const decoration_Rock_2 = shapetownSquare.createLayer(
            "Decoration/Rock3",
            ["RockOnGrass_V04", "RockOnGrass_V03"],
            0,
            0
        );

        // decoration_Rock_3
        const decoration_Rock_3 = shapetownSquare.createLayer(
            "Decoration/Rock2",
            [
                "RockOnGrass_V01",
                "RockOnGrass_V04",
        ...
        const nPC_NPC_Rowan_Capitian_1 = shapetownSquare.createLayer(
            "NPC/NPC Rowan Capitian",
            ["NPCRowan_Fullset_Walk_V01"],
            0,
            0
        );
        ...
        // npcmarcus
        const npcmarcus = this.add.sprite(
            3695,
            1150,
            "NPCMarcus_Mining_Fullset",
            8
        ...
        // tree_left_side
        const tree_left_side = shapetownSquare.createLayer(
            "Tree left side/7",
            ["TreePatteren"],
            0,
            0
        ...
        // npcRowan
        const npcRowan = this.add.sprite(
            2000,
            592,
            "NPCRowan_Fullset_Attack",
            0
        );
        npcRowan.play("NpcRowan");

        // npcRowan_1
        const npcRowan_1 = this.add.sprite(
            1999,
            658,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_2
        const npcRowan_2 = this.add.sprite(
            1998,
            720,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_3
        const npcRowan_3 = this.add.sprite(
            2064,
            720,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_4
        const npcRowan_4 = this.add.sprite(
            2064,
            656,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_5
        const npcRowan_5 = this.add.sprite(
            2064,
            592,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_6
        const npcRowan_6 = this.add.sprite(
            2128,
            717,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_7
        const npcRowan_7 = this.add.sprite(
            2129,
            654,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_8
        const npcRowan_8 = this.add.sprite(
            2127,
            591,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // npcRowan_9
        const npcRowan_9 = this.add.sprite(
            2191,
            656,
            "NPCRowan_Fullset_Attack",
            0
        ...
        // barricade_V_3
        const barricade_V_3 = this.add.image(
            2677.604054921068,
            742.8488833372835,
            "Barricade_V01",
            0
        ...
        // sceneTile_1
        /** @type {Phaser.GameObjects.Sprite & { body: Phaser.Physics.Arcade.Body }} */
        const sceneTile_1 = this.add.sprite(
            240.4704012575195,
            1552.3873203812645,
            "Fruitbushes_V01",
            23
        ...
        this.forager_home_Baket_of_mushrooms_1 =
            forager_home_Baket_of_mushrooms_1;
    ...
    initInventorySystem() {
        ...
        this.time.delayedCall(100, () => {
            import("../../components/GlobalInvetoryManager").then(
                ({ globalInventory }) => {
                    this.newItemHudPrefab.syncWithGlobalInventory =
                        function () {
                            globalInventory.quickItems.forEach(
                                (itemData, index) => {
                                    if (!itemData) return;
                                    ...
                                    if (this.items[index]) {
                                        ...
                                        this.items[index].setTexture(
                                            itemData.textureKey || itemData.icon
                                        );
                                        if (itemData.frameName !== undefined) {
                                            this.items[index].setFrame(
                                                itemData.frameName
                                            );
                                        }
                                    }
                            ...
                            this.mainInventoryData = [
                                ...globalInventory.mainItems,
                            ];

                            if (this.reactEvent) {
                                this.reactEvent.emit(
                                    "inventory-changed",
                    ...
                    this.newItemHudPrefab.updateGlobalInventory = function () {
                        const updatedQuickItems = this.itemData.map(
                            (id, index) => {
                                if (!id) return null;
                    ...
                    if (
                        globalInventory.quickItems.every(
                            (item) => item === null
                        ) &&
                    ...
                    this.time.delayedCall(500, () => {
                        if (this.newItemHudPrefab.selectedItem === null) {
                            for (
                                let i = 0;
                                i < this.newItemHudPrefab.itemData.length;
                                i++
                            ) {
                                if (this.newItemHudPrefab.itemData[i]) {
                                    this.newItemHudPrefab.selectedItem =
                                        this.newItemHudPrefab.itemData[i];
                                    this.newItemHudPrefab.activeIndex = i;

                                    if (this.newItemHudPrefab.activeItemSlots) {
                                        this.newItemHudPrefab.activeItemSlots.forEach(
                                            (slot) => {
                                        ...
                                        if (
                                            ...
                                            this.newItemHudPrefab.activeItemSlots[
                                                i
                                            ].visible = true;
                                        }
                                    }
    ...
    setupNPCGreetingTracking() {
        ...
        this.checkAllNPCsGreeted = function () {
            ...
            if (npcsToGreet.every((npc) => this.greetedNPCs.has(npc))) {
                console.log(
                    "All NPCs have been greeted! Completing Quest #003"
                );
                ...
                if (this.triggerQuestEvent) {
                    ...
                    if (this.alertPrefab) {
                        this.alertPrefab.alert(
                            "Quest Completed: Good Invitation"
                        );
                    }
                }
                return true;
    ...
    setupQuestNPCs() {
        ...
        if (this.nPCVictoria) {
            ...
            const originalVictoriaPointerDown =
                this.nPCVictoria.listeners("pointerdown")[0];

            if (originalVictoriaPointerDown) {
                this.nPCVictoria.off(
                    "pointerdown",
                    originalVictoriaPointerDown
                );
        ...
        if (this.merchantPrefab && this.merchantPrefab.npc) {
            ...
            const originalLydiaPointerDown =
                this.merchantPrefab.npc.listeners("pointerdown")[0];

            if (originalLydiaPointerDown) {
                this.merchantPrefab.npc.off(
                    "pointerdown",
                    originalLydiaPointerDown
                );

                this.merchantPrefab.npc.on(
                    "pointerdown",
                    function (_pointer) {
        ...
        if (this.foodMerchant && this.foodMerchant.npc) {
            console.log(
                "Setting up Lily (Food Merchant) for quest interactions"
            );

            const originalFoodMerchantPointerDown =
                this.foodMerchant.npc.listeners("pointerdown")[0];

            if (originalFoodMerchantPointerDown) {
                this.foodMerchant.npc.off(
                    "pointerdown",
                    originalFoodMerchantPointerDown
                );

                this.foodMerchant.npc.on(
                    "pointerdown",
                    function (_pointer) {
        ...
        if (this.blackSmithPrefab && this.blackSmithPrefab.npc) {
            ...
            const originalBlacksmithPointerDown =
                this.blackSmithPrefab.npc.listeners("pointerdown")[0];

            if (originalBlacksmithPointerDown) {
                this.blackSmithPrefab.npc.off(
                    "pointerdown",
                    originalBlacksmithPointerDown
                );

                this.blackSmithPrefab.npc.on(
                    "pointerdown",
                    function (_pointer) {
            ...
            box.on(
                ...
                () => {
                    if (box.frame.name === 0) {
                        ...
                        this.newItemHudPrefab.selectedItem =
                            this.newItemHudPrefab.itemData[index];
    ...
    setupInteractionZones() {
        ...
        this.physics.add.overlap(
            this.playerPrefab,
            blacksmithZone,
            this.handleBlacksmithInteraction,
            null,
            this
        );
        ...
        this.physics.add.overlap(
            this.playerPrefab,
            townHallZone,
            this.handleTownHallInteraction,
            null,
            this
        );
    }
    ...
    create() {
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.forager_home_Basket_of_apple_1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.mechant_MerchantCarriage_1
        );
