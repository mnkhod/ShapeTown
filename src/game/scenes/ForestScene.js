...
export default class ForestScene extends Phaser.Scene {
    ...
    editorCreate() {
        ...
        forestMap.addTilesetImage(
            "LakeFloatingRock_V03",
            "LakeFloatingRock_V03"
        );
        forestMap.addTilesetImage("LakeAccessor", "LakeAccessor");
        forestMap.addTilesetImage(
            "LakeFloatingRock_V01",
            "LakeFloatingRock_V01"
        );
        forestMap.addTilesetImage(
            "LakeFloatingRock_V02",
            "LakeFloatingRock_V02"
        );
        ...
        // backGround_1
        const backGround_1 = forestMap.createLayer(
            "BackGround",
            ["GroundTileset", "RoadStone"],
            -2208,
            -992
        );

        // ground_LowerLevel_1
        const ground_LowerLevel_1 = forestMap.createLayer(
            "Ground/LowerLevel",
            ["RoadStone"],
            -2208,
            -992
        ...
        const ground_Cliff_Make_Collutin__1 = forestMap.createLayer(
            "Ground/Cliff[Make Collutin]",
            ["ForrestLadge"],
            -2208,
            -992
        );
        ...
        // ground_TopLevel_1
        const ground_TopLevel_1 = forestMap.createLayer(
            "Ground/TopLevel",
            ["RoadStone"],
            -2208,
            -992
        ...
        // ground_Path_1
        const ground_Path_1 = forestMap.createLayer(
            "Ground/Path",
            ["RoadStone"],
            -2208,
            -992
        ...
        // stairs_Staircase_1
        const stairs_Staircase_1 = forestMap.createLayer(
            "Stairs/Staircase",
            ["ForrestLadge"],
            -2208,
            -992
        ...
        const lake_LakeBorder_Make_Collution__1 = forestMap.createLayer(
            "Lake/LakeBorder[Make Collution]",
            ["LakeBorderAni", "LakeBorderCornerAni", "GroundTileset"],
            -2208,
            -992
        );

        // lake_LakeWater_Fishing_anywhere__1
        const lake_LakeWater_Fishing_anywhere__1 = forestMap.createLayer(
            "Lake/LakeWater[Fishing anywhere]",
            [
                "GroundTileset",
                "LakeAccessor",
                "Fishes_2_32x32",
        ...
        const lake_LakeAccessor_Just_Generate__1 = forestMap.createLayer(
            "Lake/LakeAccessor[Just Generate]",
            ["LakeAccessor"],
            -2208,
            -992
        );
        ...
        const lake_FloatingStones_Animated__1 = forestMap.createLayer(
            "Lake/FloatingStones[Animated]",
            [
                "LakeFloatingRock_V01",
                "LakeFloatingRock_V02",
                "LakeFloatingRock_V03",
        ...
        // lake_WaterFall_1
        const lake_WaterFall_1 = forestMap.createLayer(
            "Lake/WaterFall",
            [
                "GroundTileset",
                "Waterfall_V01",
        ...
        // road_RoadStone_1
        const road_RoadStone_1 = forestMap.createLayer(
            "Road/RoadStone",
            ["RoadStone"],
            -2208,
            -992
        ...
        // road_Fence_1
        const road_Fence_1 = forestMap.createLayer(
            "Road/Fence",
            ["RoadStone"],
            -2208,
            -992
        ...
        const treeBorder_TreeBorderTop_1 = forestMap.createLayer(
            "TreeBorder/TreeBorderTop",
            ["TreePatteren"],
            -2208,
            -992
        );
        ...
        const treeBorder_TreeBorderTopBottom_1 = forestMap.createLayer(
            "TreeBorder/TreeBorderTopBottom",
            ["TreePatteren"],
            -2208,
            -992
        );
        ...
        const treeBorder_TreeBorder = forestMap.createLayer(
            "TreeBorder/TreeBorder2",
            ["TreePatteren"],
            -2208,
            -992
        );
        ...
        const treeBorder_TreeBorder_1 = forestMap.createLayer(
            "TreeBorder/TreeBorder1",
            ["TreePatteren"],
            -2208,
            -992
        );
        ...
        const treeBorder_TreeBorder_2 = forestMap.createLayer(
            "TreeBorder/TreeBorder3",
            ["TreePatteren"],
            -2208,
            -992
        );
        ...
        const harvert_Own_Time_cycle__PineTrees_1 = forestMap.createLayer(
            "Harvert[Own Time cycle]/PineTrees",
            ["Tree_v02"],
            -2208,
            -992
        );
        ...
        const harvert_Own_Time_cycle__AppleTree_1 = forestMap.createLayer(
            "Harvert[Own Time cycle]/AppleTree",
            ["Tree_v014"],
            -2208,
            -992
        );
        ...
        const assets_Become_Tree_DeadTree_1 = forestMap.createLayer(
            "Assets Become Tree/DeadTree",
            ["Tree_v08", "Tree_v09"],
            -2208,
            -992
        );
        ...
        const assets_Become_Tree_Branches_1 = forestMap.createLayer(
            "Assets Become Tree/Branches",
            ["GroundAccessor"],
            -2208,
            -992
        );
        ...
        const usePickaxe_to_remove_Stone_1 = forestMap.createLayer(
            "UsePickaxe to remove/Stone",
            ["GroundAccessor"],
            -2208,
            -992
        );
        ...
        const harvet_Respawn_randomly_around_Trees__Mushrooms_1 =
            forestMap.createLayer(
                "Harvet[Respawn randomly around Trees]/Mushrooms",
                ["GroundAccessor"],
                -2208,
                -992
            );
        ...
        const treeHouseFence_Make_collusion__1 = forestMap.createLayer(
            "TreeHouseFence[Make collusion]",
            ["RoadStone"],
            -2208,
            -992
        );
        ...
        // treeHouse_1
        const treeHouse_1 = forestMap.createLayer(
            "TreeHouse",
            ["TreeHouse"],
            -2208,
            -992
        ...
        const harvert_Own_Time_cycle__Maple_tree_1 = forestMap.createLayer(
            "Harvert[Own Time cycle]/Maple tree",
            ["Tree_v04", "Tree_v014"],
            -2208,
            -992
        );
        ...
        this.lake_LakeBorder_Make_Collution__1 =
            lake_LakeBorder_Make_Collution__1;
        this.lake_LakeWater_Fishing_anywhere__1 =
            lake_LakeWater_Fishing_anywhere__1;
        this.lake_LakeAccessor_Just_Generate__1 =
            lake_LakeAccessor_Just_Generate__1;
        ...
        this.treeBorder_TreeBorderTopBottom_1 =
            treeBorder_TreeBorderTopBottom_1;
        ...
        this.harvert_Own_Time_cycle__PineTrees_1 =
            harvert_Own_Time_cycle__PineTrees_1;
        this.harvert_Own_Time_cycle__AppleTree_1 =
            harvert_Own_Time_cycle__AppleTree_1;
        ...
        this.harvet_Respawn_randomly_around_Trees__Mushrooms_1 =
            harvet_Respawn_randomly_around_Trees__Mushrooms_1;
        this.treeHouseFence_Make_collusion__1 =
            treeHouseFence_Make_collusion__1;
        this.treeHouse_1 = treeHouse_1;
        this.playerPrefab = playerPrefab;
        this.harvert_Own_Time_cycle__Maple_tree_1 =
            harvert_Own_Time_cycle__Maple_tree_1;
    ...
    create() {
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.usePickaxe_to_remove_Stone_1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.assets_Become_Tree_DeadTree_1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.assets_Become_Tree_Branches_1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.treeBorder_TreeBorderTop_1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.lake_FloatingStones_Animated__1
        );
        ...
        this.physics.add.collider(
            this.playerPrefab,
            this.ground_Cliff_Make_Collutin__1
        );
